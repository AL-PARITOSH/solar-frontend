...
import { CheckCircle2, AlertTriangle, Snowflake, BarChart3 } from 'lucide-react';
...
export default function ResultsCard({ data }: { data: PredictionResponse }) {
  ...
  return (
    <motion.div 
      ...
      className="bg-solar-800 border border-solar-border rounded-2xl p-6 shadow-2xl relative overflow-hidden h-full"
    >
